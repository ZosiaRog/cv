...
\definecolor{fillfooter}{HTML}{09669F}

  \begin{tikzpicture}[remember picture,overlay]
    \node [rectangle, fill=fillfooter, anchor=south, minimum width=\paperwidth, minimum height=6cm, opacity=0.1] (box) at (current page.south){};
    ...
    \node [anchor=north, text width=19cm] at (quote2.south) {%
      \fontsize{12pt}{20pt}\color{header}%
      \emph{Zofia has worked with remarkable independence, and have shown excellent control of the techniques.
}\\
	\begin{flushright}
		Paolo Dai Pra, Full Professor, University of Padova
	\end{flushright}
    };
  \end{tikzpicture}
