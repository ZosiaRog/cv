...
\header{Zofia}{Rogala}{Finding a solution to any challenge with enthusiasm and team effort} % Your name and current job title/field
...
%----------------------------------------------------------------------------------------
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node [rectangle, fill=white, anchor=south, minimum width=\paperwidth, minimum height=5.2cm, opacity=0.1] (box) at (current page.south){};
    \node [anchor=center,text width=19cm, yshift = 2cm] (quote1) at (box) {%
    ...
    \node [yshift=-0.7cm, anchor=north, text width=19cm] (footnote) at (quote2.south) {%
      \fontsize{12pt}{20pt}\color{header}%
      {\scriptsize \fontspec[Color=lightgray]{Lato Regular}I agree for my personal data to be  processed by (company name) for the purpose of recruitment for the position I am applying for.}
    };
  \end{tikzpicture}
